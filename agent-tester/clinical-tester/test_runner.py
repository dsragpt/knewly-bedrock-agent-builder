    ...
    def _load_config(self, config_path):
        ...
        try:
            with open(config_path, 'r') as f:
                config = json.load(f)
                return config['clinical_trials']  # Get the clinical trials agent config
            ...
            logger.error("Clinical trials agent configuration not found in config file")
            raise
